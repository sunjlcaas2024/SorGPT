...
# 纯向量 top-k 会漏掉"摘要/正文才提到查询实体"的论文（E048 只出现摘要、rank155 被
# top-100 英文池剔除；hongyingzi 摘要论文 top-300 只进 3-6 篇）。中英文查询都生效。
# True = 查询中低频 token（E048/CHBZ/hongyingzi 等）逐字扫 meta 文档，命中篇数

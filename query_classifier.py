...
def _is_review(q): return any(p in q for p in [
    ...
    "which papers","which studies","which publications","which articles",
    "which research","which reports","report the","describe the","investigate the",
    "哪些论文","哪些文献","哪些研究","哪些文章","报道了","报告了",
